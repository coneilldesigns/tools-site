    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {Object.entries(fancyStyles).map(([style, label]) => (
          <button
            ...
            className="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            {label}
          </button>
        ))}
      ...
      {fancyText && (
        <div className="p-4 rounded-lg bg-white dark:bg-gray-700 shadow-sm">
          ...
          <div className="p-2 rounded bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white text-lg">
            {fancyText}
          </div>
        </div>
      )}
